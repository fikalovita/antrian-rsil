                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <a href="pages/nomor" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <a href="pages/panggilan" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                                Tampilkan <i class="bi-arrow-right ms-2"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <p class="mb-5">Halaman Display Antrian digunakan menampilkan jumlah antrian.</p>
                            <a href="pages/display" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                                Tampilkan <i class="bi-arrow-right ms-2"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <h3>Pemanggil Antrian Farmasi</h3>
                            <p class="mb-5">Halaman Display Antrian digunakan menampilkan jumlah antrian.</p>
                            <a href="pages/panggilan-farmasi" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                                Tampilkan <i class="bi-arrow-right ms-2"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <h3>Display Antrian Farmasi</h3>
                            <p class="mb-5">Halaman Panggilan Antrian digunakan petugas loket untuk memanggil antrian pengunjung farmasi.</p>
                            <a href="http://localhost/webapps/antrianfarmasi.php" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                                Tampilkan <i class="bi-arrow-right ms-2"></i>
                            </a>
                        </div>
                    </div>
